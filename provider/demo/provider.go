...
// Name 方法直接将服务对应的字符串凭证返回，在这个例子里就是""hade.demo"
func (sp *DemoServiceProvider) Name() string {
	return Key
}

// Register 方法是注册初始化服务实例的方法，这里暂定为NewDemoService
...
// Params 方法表示实例化的参数。我们这里只实例化一个参数 container, 表示我们在 NewDemoService 这个函数中，只有一个参数
